...
// DASHBOARD
// const dashboard = app => app.get('/dashboard', (req, res) => {
//   res.status(200).json({
//     status: 'success',
//   });
// });
...
const appGet = app => app.get('/', (req, res) => {
  ...
  res.send(
    JSON.stringify({
      ...
      message: 'This is CloudBoost API. It should be running on port 1440.',
    }),
  );
});

const appFilesGet = app => app.get('/getFile/:filename', (req, res) => {
