...
// const dashboardApp = express(); // dashboard
// const dashboardHttp = require('http').createServer(dashboardApp); // dashboard
...
// const dashboard = config.dashboardPort || 1440;
// dashboardHttp.listen(dashboard, () => {
//   dashboardApp.get('/', async (req, res) => {
//     res.status(200).json({
//       status: 'success',
//     });
//   });
